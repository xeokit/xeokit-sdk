/**
 ...
 new xeokit.Mesh({
     ...
     geometry: new xeokit.PathGeometry({

        divisions: 10,

        path: new xeokit.Path({

            // Subpaths

            curves: [
                new xeokit.CubicBezierCurve({
                    v0: [-10, 0, 0],
                    v1: [-5, 15, 0],
                    v2: [20, 15, 0],
                    v3: [10, 0, 0]
                }),
                new xeokit.QuadraticBezierCurve({
                    v0: [10, 0, 0],
                    v1: [30, 15, 0],
                    v2: [20, 0, 0]
                }),
                new xeokit.SplineCurve({
                    points: [
                        [20, 0, 0],
                        [-5, 15, 0],
                        [20, 15, 0],
...
const type = "xeokit.PathGeometry";
