...
import {PerformanceNode} from "../models/VBOSceneModel/lib/PerformanceNode.js";
    ...
    set entity(entity) {
        ...
        if (this._entity) {
            if (this._entity instanceof PerformanceNode) {
                this._onEntityModelDestroyed = this._entity.model.on("destroyed", () => { // PerformanceNode does not fire events, and cannot exist beyond its VBOSceneModel
