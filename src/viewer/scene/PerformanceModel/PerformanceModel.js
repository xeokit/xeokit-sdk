 ...
 *
 * [![](http://xeokit.io/img/docs/sceneGraph.png)](/examples/#sceneRepresentation_PerformanceModel_instancing)
 *
 * [[Run this example](/examples/#sceneRepresentation_PerformanceModel_instancing)]
 *
 * ````javascript
 ...
 *
 *  [![](http://xeokit.io/img/docs/sceneGraph.png)](/examples/#sceneRepresentation_PerformanceModel_batching)
 *
 * * [[Run this example](/examples/#sceneRepresentation_PerformanceModel_batching)]
 *
 * ````javascript
 * import {Viewer, PerformanceModel} from "xeokit-sdk.es.js";
 *
 ...
 * [![](http://xeokit.io/img/docs/sceneGraph.png)](/examples/#sceneRepresentation_PerformanceModel_batching)
 *
 * * [[Run this example](/examples/#sceneRepresentation_PerformanceModel_instancing_origin)]
 *
 * ````javascript
 ...
 * [![](http://xeokit.io/img/docs/sceneGraph.png)](/examples/#sceneRepresentation_PerformanceModel_batching)
 *
 * * [[Run this example](/examples/#sceneRepresentation_PerformanceModel_batching_origin)]
 *
 * ````javascript
 * const origin = [100000000, 0, 100000000];
 *
