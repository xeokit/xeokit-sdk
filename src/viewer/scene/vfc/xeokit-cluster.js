        ...
        cellsByEntity)
    {
        ...
        Object.keys (cellsByEntity).forEach (function (entityId) {
            ...
            trianglesForEntityCellsCount [numCellsForEntity] =
                (trianglesForEntityCellsCount [numCellsForEntity] || 0) + numPrimitives;
    
            totalTriangles += numPrimitives;
        });
        ...
        generateSpiralIndexes (
            ...
            do {
                for (; i < entitiesToProcess.length; i++)
                {
                    ...
                    if (numPrimitives > remainingTriangles)
                    {
                    ...
                    remainingTriangles -= numPrimitives;
                }
