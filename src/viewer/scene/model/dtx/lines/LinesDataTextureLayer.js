...
import {getDataTextureRenderers} from "./LinesDataTextureRenderers.js";
import {LinesDataTextureBuffer} from "./LinesDataTextureBuffer.js";
 ...
 * @private
 */
export class LinesDataTextureLayer {
    ...
    constructor(model, cfg) {
        ...
        this.layerIndex = cfg.layerIndex; // Index of this LinesDataTextureLayer in {@link SceneModel#_layerList}.
        this._dataTextureRenderers = getDataTextureRenderers(model.scene);
        this.model = model;
        this._buffer = new LinesDataTextureBuffer();
