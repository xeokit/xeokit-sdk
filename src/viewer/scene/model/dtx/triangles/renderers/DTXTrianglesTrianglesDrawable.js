 ...
 * @private
 */
export class DTXTrianglesTrianglesDrawable {
    ...
    constructor(programName, scene, cfg) {
        ...
        const buildVertexShader = () => {
            ...
            appendVertexOutputs(src, needVertexColor && "color", needPickColor && "pickColor", needGl_Position &&"gl_Position", needViewMatrixPositionNormal && {viewMatrix: "viewMatrix", viewPosition: "viewPosition", viewNormal: "viewNormal"});
        ...
        const uCameraEyeRtc = program.getLocation("uCameraEyeRtc");
