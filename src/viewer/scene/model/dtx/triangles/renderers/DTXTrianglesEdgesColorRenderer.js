...
export class DTXTrianglesEdgesColorRenderer {
    ...
    constructor(scene) {
        ...
        this._appendVertexOutputs = (src, color, pickColor, gl_Position, view) => src.push(`vColor = vec4(vec3(${color}.rgb) * 0.5, float(${color}.a)) / 255.0;`);
        ...
        this._appendFragmentOutputs = (src, vWorldPosition, gl_FragCoord) => src.push("   outColor = vColor;");
