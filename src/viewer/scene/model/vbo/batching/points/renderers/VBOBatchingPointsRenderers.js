...
class VBOBatchingPointsRenderers {
    ...
    get pickMeshRenderer() {
        if (!this._pickMeshRenderer) {
            this._pickMeshRenderer = new VBOPointsPickMeshRenderer(this._scene, false);
        }
    ...
    get pickDepthRenderer() {
        if (!this._pickDepthRenderer) {
            this._pickDepthRenderer = new VBOPointsPickDepthRenderer(this._scene, false);
        }
    ...
    get occlusionRenderer() {
        if (!this._occlusionRenderer) {
            this._occlusionRenderer = new VBOPointsOcclusionRenderer(this._scene, false);
        }
