 ...
 * @private
 */
class VBOBatchingPointsOcclusionRenderer extends VBORenderer {

    constructor(scene) {
        super(scene, false, { instancing: false, primType: "pointType", progMode: "occlusionMode", hashPointsMaterial: true });
    }
