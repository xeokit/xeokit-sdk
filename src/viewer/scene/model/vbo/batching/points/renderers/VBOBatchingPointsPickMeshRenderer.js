 ...
 * @private
 */
export class VBOBatchingPointsPickMeshRenderer extends VBORenderer {

    constructor(scene) {
        super(scene, false, { instancing: false, primType: "pointType", progMode: "pickMeshMode", hashPointsMaterial: true });
    }
