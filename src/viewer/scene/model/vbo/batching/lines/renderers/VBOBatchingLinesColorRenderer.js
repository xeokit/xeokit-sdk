 ...
 * @private
 */
export class VBOBatchingLinesColorRenderer extends VBORenderer {

    constructor(scene) {
        super(scene, false, { instancing: false, primType: "lineType", progMode: "colorMode", incrementDrawState: true });
    }
