...
class Renderers {
    ...
    get flatColorRenderer() {
        if (!this._flatColorRenderer) {
            this._flatColorRenderer = new VBOTrianglesFlatColorRenderer(this._scene, false, false);
        }
    ...
    get flatColorRendererWithSAO() {
        if (!this._flatColorRendererWithSAO) {
            this._flatColorRendererWithSAO = new VBOTrianglesFlatColorRenderer(this._scene, false, true);
        }
    ...
    get silhouetteRenderer() {
        if (!this._silhouetteRenderer) {
            this._silhouetteRenderer = new VBOTrianglesSilhouetteRenderer(this._scene, false);
        }
    ...
    get pickNormalsRenderer() {
        if (!this._pickNormalsRenderer) {
            this._pickNormalsRenderer = new VBOTrianglesPickNormalsRenderer(this._scene, false);
        }
    ...
    get pickNormalsFlatRenderer() {
        if (!this._pickNormalsFlatRenderer) {
            this._pickNormalsFlatRenderer = new VBOTrianglesPickNormalsFlatRenderer(this._scene, false);
        }
    ...
    get pickDepthRenderer() {
        if (!this._pickDepthRenderer) {
            this._pickDepthRenderer = new VBOTrianglesPickDepthRenderer(this._scene, false);
        }
    ...
    get snapRenderer() {
        if (!this._snapRenderer) {
            this._snapRenderer = new VBOTrianglesSnapRenderer(this._scene, false, false);
        }
    ...
    get snapInitRenderer() {
        if (!this._snapInitRenderer) {
            this._snapInitRenderer = new VBOTrianglesSnapRenderer(this._scene, false, true);
        }
