...
export class VBOBatchingTrianglesLayer {
    ...
    finalize() {
        ...
        const positions = (state.positionsDecodeMatrix
                           ...
                           : (quantizePositions(buffer.positions.compileBuffer(Float32Array), this._modelAABB, state.positionsDecodeMatrix = math.mat4())));
    ...
    __drawLayer(renderFlags, frameCtx, renderer, pass) {
        if ((this._numCulledLayerPortions < this._numPortions) && (this._numVisibleLayerPortions > 0)) {
            ...
            if (backfacePasses.includes(pass)) {
                // _updateBackfaceCull
    ...
    drawEdgesColorOpaque(renderFlags, frameCtx) {
        if (this._numEdgesLayerPortions > 0) {
