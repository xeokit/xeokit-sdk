 ...
 * @private
 */
class VBOInstancingPointsDepthRenderer extends VBORenderer {

    constructor(scene) {
        super(scene, false, { instancing: true, primType: "pointType", progMode: "depthMode", hashPointsMaterial: true });
    }
