 ...
 * @private
 */
export class VBOInstancingPointsSilhouetteRenderer extends VBORenderer {

    constructor(scene) {
        super(scene, false, { instancing: true, primType: "pointType", progMode: "silhouetteMode", hashPointsMaterial: true, colorUniform: true });
    }
