...
export class VBOInstancingPointsSnapRenderer extends VBORenderer {
    ...
    constructor(scene, isSnapInit) {
        super(scene, false, { instancing: true, primType: "pointType", progMode: isSnapInit ? "snapInitMode" : "snapMode" });
    }
    ...
    _buildVertexShader() {
        ...
        src.push("// VBOInstancingPointsSnapRenderer vertex shader");
    ...
    _buildFragmentShader() {
        ...
        const src = [];
        src.push ('#version 300 es');
        src.push("// VBOInstancingPointsSnapRenderer fragment shader");
        src.push("#ifdef GL_FRAGMENT_PRECISION_HIGH");
        src.push("precision highp float;");
        src.push("precision highp int;");
        src.push("#else");
