 ...
 * @private
 */
export class VBOInstancingLinesSilhouetteRenderer extends VBORenderer {

    constructor(scene) {
        super(scene, false, { instancing: true, primType: "lineType", progMode: "silhouetteMode", colorUniform: true });
    }
