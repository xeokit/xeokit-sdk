...
export class VBOTrianglesColorTextureRenderer extends VBORenderer {
    ...
    constructor(scene, instancing, primitive, withSAO, useAlphaCutoff) {
        super(scene, instancing, primitive, withSAO, { progMode: "colorTextureMode", incrementDrawState: true, useAlphaCutoff: useAlphaCutoff, hashLigthsSAO: true, hashGammaOutput: true });
    }
