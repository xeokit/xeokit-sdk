 ...
 * @private
 */
export class VBOPointsDepthRenderer extends VBORenderer {

    constructor(scene, instancing) {
        if (! instancing) {
            throw "Batching Points Depth Renderer not implemented";
        }
        super(scene, false, { instancing: instancing, primType: "pointType", progMode: "depthMode", hashPointsMaterial: true });
    }
