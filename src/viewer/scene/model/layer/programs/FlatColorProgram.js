export const FlatColorProgram = function(programVariables, geometry, logarithmicDepthBufferEnabled, lightSetup, sao) {
    const vViewPosition = programVariables.createVarying("vec4", "vViewPosition", () => geometry.attributes.position.view);
    const vColor = programVariables.createVarying("vec4", "vColor", () => geometry.attributes.color);
