...
class CubicBezierCurve extends Curve {
    ...
    set v0(value) {
         ...
         */
        this.fire("v0", this._v0 = value || xeokit.math.vec3([0, 0, 0]));
    }
    ...
    set v1(value) {
         ...
         * @param value The property's new value
         */
        this.fire("v1", this._v1 = value || xeokit.math.vec3([0, 0, 0]));
    }
    ...
    set v2(value) {
         ...
         * @param value The property's new value
         */
        this.fire("v2", this._v2 = value || xeokit.math.vec3([0, 0, 0]));
    }
    ...
    set v3(value) {
         ...
         * @param value The property's new value
         */
        this.fire("v3", this._v3 = value || xeokit.math.vec3([0, 0, 0]));
    }
