    ...
    activate() {
                ...
                case TOUCH_FINDING_ORIGIN:
                    ...
                    longTouchTimeout = setTimeout(() => {
                        if (longTouchTimeout !== null) {
                            ...
                            longTouchTimeout = null;
                            console.log("touchstart: this._touchState= TOUCH2_FINDING_ORIGIN-> (timeout) TOUCH_FINDING_ORIGIN")
                        }
                    }, this._longTouchTimeoutMs);
                    this._touchState = TOUCH2_FINDING_ORIGIN;
                    console.log("touchstart: this._touchState= TOUCH_FINDING_ORIGIN -> TOUCH2_FINDING_ORIGIN")
                    break;

                case TOUCH2_FINDING_ORIGIN:
                    if (longTouchTimeout) {
                        clearTimeout(longTouchTimeout);
                        longTouchTimeout = null;
                    }
                    ...
                    if (snapPickResult && snapPickResult.worldPos) {
                        ...
                        console.log("touchstart: this._touchState= TOUCH2_FINDING_ORIGIN -> LONG_TOUCH_FINDING_ORIGIN")
                    } else {
                        ...
                        if (pickResult && pickResult.worldPos) {
                            ...
                            this._touchState = TOUCH_FINDING_ORIGIN;
                            console.log("touchstart: this._touchState= TOUCH2_FINDING_ORIGIN -> TOUCH_FINDING_ORIGIN")
                        }
                    }
                    break;
                ...
                case TOUCH2_FINDING_TARGET: {
                    ...
                    if (snapPickResult && snapPickResult.worldPos) {
                        ...
                        if (pickResult && pickResult.worldPos) {
                            ...
                            this._touchState = TOUCH_FINDING_ORIGIN;
                            console.log("touchstart: this._touchState= TOUCH2_FINDING_TARGET -> TOUCH_FINDING_ORIGIN")
                        }
                    }
                    break;
                }
        ...
        canvas.addEventListener("touchend", this._onCanvasTouchEnd = (event) => {
            ...
            switch (this._touchState) {
                ...
                case TOUCH2_FINDING_ORIGIN:
                    this._touchState = TOUCH2_FINDING_ORIGIN;
                    console.log("touchend: this._touchState= TOUCH2_FINDING_ORIGIN -> TOUCH2_FINDING_ORIGIN")
                    break;
